...
ACTIONS = {
    ...
    "sdk":          (["sdk_demo.py"], "Explicit PennyLane circuit (engine match ~3.9e-16)", False),
    ...
    "credit_audit": (["credit_audit.py"], "Re-derive the whole-program QPU cost from published pricing; assert every campaign + the org ceiling (no API key needed)", False),
